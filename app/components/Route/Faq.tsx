...
const Faq = (props: Props) => {
    ...
    const toggleHandle=(id:any)=>{
        setFaqData((pre)=>pre?.map((faq:any)=>faq._id===id?{...faq,active:!faq.active}:faq))
        }
  return (
    <div className='w-[90%] m-auto'>
    <br />
    <br />
    <h1 className='text-center font-Poppins text-[25px] leading-[35px] sm:text-3xl dark:text-white text-black 800px:leading-[60px] font-[700] tracking-tight'>Frequently Asked <span className='bg-gradient-to-r from-pink-400 via-purple-500 to-sky-400 bg-clip-text text-transparent font-[800]'> Questions</span></h1>
    <br />
