...
const Courses = (props: Props) => {
  ...
  return (
    <div>
      <div className="w-[75%] md:w-[80%] m-auto ">
        ...
        <br />
        <div className="grid  grid-cols-1 gap-[10px] md:grid-cols-2 md:gap-[25px] lg:grid-cols-3 lg:gap-[30px] 1500px:grid-cols-4 1500px:gap-[35px] mb-12 border-0">
          {courseData &&
