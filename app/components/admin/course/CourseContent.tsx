              ...
              <>
                <div className="flex w-full items-center">
                  <input
                    ...
                    onChange={(e) => {
                      const updateData = [...courseContentData];
                      updateData[index] = {...updateData[index] ,videoSection :e.target.value};
                      setCourseContentData(updateData);
                    }}
                  />
              ...
              <>
                <div className="my-8">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const updateData = [...courseContentData];
                      updateData[index]={...updateData[index],videoUrl:e.target.value};
                      setCourseContentData(updateData);
                    }}
                  />
                </div>
                <div className="my-8">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const updateData = [...courseContentData];
                      updateData[index]={...updateData[index],videoLength:e.target.value};
                      setCourseContentData(updateData);
                    }}
                  />
                </div>
                ...
                <div className="my-8">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const updateData = [...courseContentData];
                      updateData[index]={...updateData[index],title:e.target.value};
                      setCourseContentData(updateData);
                    }}
                  />
                </div>
                ...
                <div className="my-8">
                  ...
                  <textarea
                    ...
                    onChange={(e) => {
                      const updateData = [...courseContentData];
                      updateData[index]={...updateData[index],description:e.target.value};
                      setCourseContentData(updateData);
                    }}
                  />
                </div>
                <div className="my-8">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const updateData = [...courseContentData];
                      updateData[index]={...updateData[index],suggestion:e.target.value};
                      setCourseContentData(updateData);
                    }}
                  />
                </div>
                ...
                {item?.links?.map((links: any, linkindex: number) => (
                  <div className=" mb-3 block" key={index}>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const updateData = [...courseContentData];
                        updateData[index]= {...updateData[index],
                          links: updateData[index].links.map((link:any, i:any) =>
                            i === linkindex ? { ...link, title: e.target.value } : link
                          ),};
                        setCourseContentData(updateData);
                      }}
                    />
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        updateData[index] ={...updateData[index],
                          links: updateData[index].links.map((link:any, i:any) =>
                            i === linkindex ? { ...link, url: e.target.value } : link
                          ),};
                        setCourseContentData(updateData);
                      }}
                    />
